...
export default function StreetContentList({ cityCode, langCode, mapStreetContent, titleSize = "text-3xl" }: { cityCode: string, langCode: string, mapStreetContent: {
