  ...
  return (
    <div className="grid grid-cols-3 gap-3 sm:gap-4">
      ...
      >
        ...
        <div className="relative flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-b from-white/90 via-gray-50/90 to-gray-100/90 text-gray-900 rounded-2xl sm:rounded-full backdrop-blur-2xl transition-all duration-500 border border-white/60 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.8),0_3px_6px_-1px_rgba(0,0,0,0.15)] hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9),0_6px_8px_-3px_rgba(0,0,0,0.2)] active:translate-y-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 group-hover:scale-110 transition-transform duration-300">
