        ...
        <div className="relative z-10 flex flex-col gap-16 items-center justify-center h-full text-white text-center px-4">
          ...
          <div className="text-xs flex flex-wrap items-center gap-4">
            {cityDetail.official_web_tour ? (
              <LinkForHeader title="Website" href={cityDetail.official_web_tour} icon={<IconWebsiteRound />} />
            ) : cityDetail.official_web ? (
              <LinkForHeader title="Website" href={cityDetail.official_web} icon={<IconWebsiteRound />} />
            ) : null}
            {cityDetail.google_map_url && (
              <LinkForHeader title="Map" href={cityDetail.google_map_url} icon={<IconMap />} />
            )}
            {cityDetail.instagram_tour_id ? (
              <LinkForHeader title="Instagram" href={`https://www.instagram.com/${cityDetail.instagram_tour_id}`} icon={<IconInstagramRound />} />
            ) : cityDetail.instagram_official_id && (
              <LinkForHeader title="Instagram" href={`https://www.instagram.com/${cityDetail.instagram_official_id}`} icon={<IconInstagramRound />} />
            )}
