...
import CardYoutubeTypeTwo from "../comp-card/card-youtube-type-two";
import SectionTitle from "../section-title";

/**
 * City Detail 페이지에서 유튜브 리스트 컴포넌트
 * @param youtubeVideos 유튜브 비디오 리스트
 * @returns 유튜브 리스트 컴포넌트
 */
export default function CityYoutubeList({ youtubeVideos, titleSize = "text-3xl", showTitle = true }: { youtubeVideos: {
