...
export const InfoItem = ({
  ...
  return (
    <li className="px-6 p-4 rounded-full flex items-center gap-4 w-full bg-white/90 border border-white transition-all duration-300 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.8),0_1px_1px_0px_rgba(0,0,0,0.15)] hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9),0_6px_8px_-5px_rgba(0,0,0,0.2)] active:translate-y-0 overflow-hidden">
