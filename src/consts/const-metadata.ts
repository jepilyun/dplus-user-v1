...
export const DEFAULT_METADATA_I18N = {
  ...
  KO: {
    ...
    og_image_width: 1200,
    og_image_height: 630,
    og_image_alt: "dplus | 지금 핫한 콘서트·축제·팝업, 한눈에 보고 바로 저장!",
  },
  JA: {
    title:
  ...
  TW: {
    ...
    og_image_width: 1200,
    og_image_height: 630,
    og_image_alt: "dplus｜熱門音樂會・慶典・展覽・快閃行程，立即加入行事曆",
  },
  ID: {
    title:
 ...
 */
export const getMetadataByLang = (langCode: string | null | undefined) => {
  if (!langCode) return DEFAULT_METADATA_I18N.EN;

  const langMap: Record<string, keyof typeof DEFAULT_METADATA_I18N> = {
    en: "EN",
    ko: "KO",
    ja: "JA",
    cn: "ZH",
